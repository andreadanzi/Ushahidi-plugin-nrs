...
?>
			<div class="bg">
				...
				<div class="tabs">
					<!-- tabset -->
					<ul class="tabset">
						<li><a href="<?php echo url::site() . 'admin/manage/nrs' ?>" class="active"><?php echo Kohana::lang('nrs.environments');?></a></li>
						<li><a href="<?php echo url::site() . 'admin/manage/node' ?>"><?php echo Kohana::lang('nrs.nodes');?></a></li>
						<li><a href="<?php echo url::site() . 'admin/manage/datastream' ?>"><?php echo Kohana::lang('nrs.datastreams');?></a></li>
						<li><a href="<?php echo url::site() . 'admin/manage/datapoint' ?>"><?php echo Kohana::lang('nrs.datapoints');?></a></li>
					</ul>
					
					<!-- tab -->
					<div class="tab">
						<ul>
							<li><a href="javascript:refreshEnvironments();"><?php echo strtoupper(Kohana::lang('nrs.refresh_environments'));?></a></li><span id="feeds_loading"></span>
						</ul>
					</div>
				</div>
				<?php if ($form_error): ?>
										...
										<tr>
											...
											<td class="col-4">
												<ul>
													...
													<li class="none-separator"><a class="status_yes" href="javascript:environmentAction('v','SHOW/HIDE','<?php echo(rawurlencode($feed_id)); ?>')"><?php if ($feed_active) { echo Kohana::lang('ui_main.visible'); } else { echo Kohana::lang('ui_main.hidden'); } ?></a></li>
													<li><a href="javascript:environmentAction('d','DELETE','<?php echo(rawurlencode($feed_id)); ?>')" class="del"><?php echo Kohana::lang('ui_main.delete');?></a></li>
												</ul>
											</td>
										</tr>
										<?php
