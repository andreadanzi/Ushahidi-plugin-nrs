...
class Environments_Controller extends Main_Controller {
	/**
	...
	public function index()
	{
		...
		$this->template->header->this_page = 'environments';
		$this->template->content = new View('nrs/nrs_environments');
		$this->themes->js = new View('nrs/nrs_environments_js');
