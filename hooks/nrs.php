...
class nrs {
	...
	public function add()
	{
		...
		if (Router::$controller == 'manage' or Router::$controller == 'nrs' or Router::$controller == 'nrs_datapoints' or Router::$controller == 'nrs_datastreams' or Router::$controller == 'nrs_environments' or Router::$controller == 'nrs_nodes')
		{
